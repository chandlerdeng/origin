...
<style lang="scss">
  ...
  .mui-navigate-right{ &:after{font-size: 0.24rem; color: $gray2;right: 0.15rem}}
  $height : 0.44rem;
  .mui-table-view{
    .mui-table-view-cell{
      padding: 0;
...
<style scoped>
  ...
  /*.mui-table-view-cell>a:not(.mui-btn){padding:0.96rem 1.23rem}*/
